		...
		<div class="loading__msg">
			<center>
				<b style="font-size: 22px;">
					<a href="https://github.com/Xcod3bughunt3r/Anti-DDoS" target="_blank" style="color: black;">Anti DDoS</a> is checking....
				</b>
				<br><br>
			...
			you will see this only one time;<br> your webpage will show up soon!
			 ...
			 <a href="https://github.com/Xcod3bughunt3r" target="_blank">ALIF FUSOBAR</a> </center></div>
	</div>
